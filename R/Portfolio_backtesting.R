...
Portfolio_backtesting <- function() {
  ...
  sumbacktest[4,1]= round(Media_MF_SHARPE,4)*100
  sumbacktest[5,1]= round(Media_MF_MKW,4)*100
  sumbacktest[6,1]= round(Media_ANNt_EQ,4)*100
  sumbacktest[7,1]= round(Media_Ret_Medio_RNA_Mkv,4)*100
  ...
  sumbacktest[4,2]= round(AVERAGE_Return(MF_MKW),4)*100
  sumbacktest[5,2]= round(AVERAGE_Return(MF_SHARPE),4)*100
  sumbacktest[6,2]= round(AVERAGE_Return(ANNt_EQ),4)*100
  sumbacktest[7,2]= round(AVERAGE_Return(ANNt_MKW),4)*100
  ...
  sumbacktest[4,3]= round(CUMULATIVE_Return(MF_MKW),4)*100
  sumbacktest[5,3]= round(CUMULATIVE_Return(MF_SHARPE),4)*100
  sumbacktest[6,3]= round(CUMULATIVE_Return(ANNt_EQ),4)*100
  sumbacktest[7,3]= round(CUMULATIVE_Return(ANNt_MKW),4)*100
  ...
  sumbacktest[4,4]= round(ANNUALIZED_VOLATILITY(MF_MKW),4)*100
  sumbacktest[5,4]= round(ANNUALIZED_VOLATILITY(MF_SHARPE),4)*100
  sumbacktest[6,4]= round(ANNUALIZED_VOLATILITY(ANNt_EQ),4)*100
  sumbacktest[7,4]= round(ANNUALIZED_VOLATILITY(ANNt_MKW),4)*100
  ...
  sumbacktest[4,5]= round(Var_95_(MF_MKW),4)*100
  sumbacktest[5,5]= round(Var_95_(MF_SHARPE),4)*100
  sumbacktest[6,5]= round(Var_95_(ANNt_EQ),4)*100
  sumbacktest[7,5]= round(Var_95_(ANNt_MKW),4)*100
  ...
  sumbacktest[4,6]= round(CVar_95(MF_MKW),4)*100
  sumbacktest[5,6]= round(CVar_95(MF_SHARPE),4)*100
  sumbacktest[6,6]= round(CVar_95(ANNt_EQ),4)*100
  sumbacktest[7,6]= round(CVar_95(ANNt_MKW),4)*100
  ...
  sumbacktest[4,7]= round(IS(MF_MKW,0.0311),2)
  sumbacktest[5,7]= round(IS(MF_SHARPE,0.0311),2)
  sumbacktest[6,7]= round(IS(ANNt_EQ,0.0311),2)
  sumbacktest[7,7]= round(IS(ANNt_MKW,0.0311),2)
  ...
  sumbacktest[4,8]= round(SortinoRatio_my(MF_MKW),2)
  sumbacktest[5,8]= round(SortinoRatio_my(MF_SHARPE),2)
  sumbacktest[6,8]= round(SortinoRatio_my(ANNt_EQ),2)
  sumbacktest[7,8]= round(SortinoRatio_my(ANNt_MKW),2)
  ...
  sumbacktest[4,9]= round(Beta(MF_MKW, Comparativo_RETORNOS[,1]),2)
  sumbacktest[5,9]= round(Beta(MF_SHARPE, Comparativo_RETORNOS[,1]),2)
  sumbacktest[6,9]= round(Beta(ANNt_EQ, Comparativo_RETORNOS[,1]),2)
  sumbacktest[7,9]= round(Beta(ANNt_MKW, Comparativo_RETORNOS[,1]),2)
  ...
  sumbacktest[4,10]= round(Alfa(MF_MKW, Comparativo_RETORNOS[,1], 0.0311)*100,2)
  sumbacktest[5,10]= round(Alfa(MF_SHARPE, Comparativo_RETORNOS[,1], 0.0311)*100,2)
  sumbacktest[6,10]= round(Alfa(ANNt_EQ, Comparativo_RETORNOS[,1], 0.0311)*100,2)
  sumbacktest[7,10]= round(Alfa(ANNt_MKW, Comparativo_RETORNOS[,1], 0.0311)*100,2)
  ...
  sumbacktest[4,11]= round(ITreynor(MF_MKW, Comparativo_RETORNOS[,1], 0.0311)*100,2)
  sumbacktest[5,11]= round(ITreynor(MF_SHARPE, Comparativo_RETORNOS[,1], 0.0311)*100,2)
  sumbacktest[6,11]= round(ITreynor(ANNt_EQ, Comparativo_RETORNOS[,1], 0.0311)*100,2)
  sumbacktest[7,11]= round(ITreynor(ANNt_MKW, Comparativo_RETORNOS[,1], 0.0311)*100,2)
  ...
  rownames(sumbacktest)= c( RM, "MARKOWITZ", "SHARPE", "MF_MKV", "MF_SHARPE",
